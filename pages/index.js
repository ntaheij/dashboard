  ...
  return (
    <main className="p-4 md:p-24">
      <div id="hello">
        ...
        <h3 className="text-xl md:text-2xl"><span className="gradient-text">Overcast Clouds</span>, <span className="gradient-text">11</span> degrees, but feels like <span className="gradient-text">9</span> degrees in <span className="gradient-text">Emmeloord</span></h3>

        <h4 className="mt-8 text-3xl md:text-4xl font-semibold">Saved <span className="gradient-text">Pages</span></h4>
        
        <div id="cards" class="md:ml-4 mt-10 mb-5 grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-3 md:gap-6">
          { 
            items.map((item) => {
              return (
                <Page 
